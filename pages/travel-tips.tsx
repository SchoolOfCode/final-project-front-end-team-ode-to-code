      ...
      <div className={styles.body}>
        <div className={styles.content}>
          <p>
            ...
            jet off to extraordinary new places, bustling new cities and weather
            so refreshingly different from home it's almost dream-like, it's
            easy to get caught up in the excitement of it it all! Thankfully,
            we're here to help you keep grounded in all the ways that matter, by
            listing the top travel tips every traveller should have in their
            arsenal.
          </p>
          ...
          <ol>
            ...
            <p>
              ...
              regard. You will never know when you might need to have some sort
              of documentation with you and might not want to always carry your
              original. A good hack is to also email these documents to
              yourself, as extra security and to give you piece of
              mind.Additionally, if your passport gets stolen, having a copy
              will come in handy for your police report.
            </p>
